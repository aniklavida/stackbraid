"""Seeds exactly what a fresh MySQL database needs to be usable: two roles
and two accounts. Idempotent — checked by presence, so running it against an
already-seeded database (every ordinary startup, after the first) is a no-op
