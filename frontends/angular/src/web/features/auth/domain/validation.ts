 ...
 * the API contract) so a form never lets through what the backend would
 * reject anyway; the backend still re-validates independently, this is only
 * for a fast, local error message.
 */
