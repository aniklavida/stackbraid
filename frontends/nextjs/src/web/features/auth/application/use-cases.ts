...
/**
 * The session port this feature needs from `shared/auth` — a use case
 * orchestrates the repository and the session store, but never imports a
 * React hook, so it stays testable as plain async functions.
 */
