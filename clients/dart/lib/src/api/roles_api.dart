...
class RolesApi {
  ...
  Future<Response<User>> assignRole({ 
    required String userId,
    required AssignRoleRequest assignRoleRequest,
    ...
    final _path = r'/v1/users/{userId}/roles'.replaceAll('{' r'userId' '}', userId.toString());
    ...
    try {
      _bodyData = jsonEncode(assignRoleRequest);
...
_responseData = rawData == null ? null : deserialize<User, User>(rawData, 'User', growable: true);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<Role>>> listRoles({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
...
_responseData = rawData == null ? null : deserialize<List<Role>, Role>(rawData, 'List<Role>', growable: true);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> revokeRole({ 
    required String userId,
    ...
    final _path = r'/v1/users/{userId}/roles/{roleId}'.replaceAll('{' r'userId' '}', userId.toString()).replaceAll('{' r'roleId' '}', roleId.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
