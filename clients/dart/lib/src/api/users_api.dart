...
import 'dart:convert';
import 'package:stackbraid_client/src/deserialize.dart';
...
class UsersApi {
  ...
  Future<Response<User>> deactivateUser({ 
    ...
    final _path = r'/v1/users/{userId}/deactivate'.replaceAll('{' r'userId' '}', userId.toString());
...
_responseData = rawData == null ? null : deserialize<User, User>(rawData, 'User', growable: true);
  ...
  /// Parameters:
  /// * [userId] 
  /// * [includeDeleted] - Include a soft-deleted user for administrative recovery.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
...
_responseData = rawData == null ? null : deserialize<User, User>(rawData, 'User', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AuditPage] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuditPage>> listUserAudit({ 
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    AuditPage? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<AuditPage, AuditPage>(rawData, 'AuditPage', growable: true);
  ...
  /// * [sort] - One sortable field, optionally prefixed with `-` for descending. Allowed fields: `email`, `displayName`, `createdAt`, `status`. Examples: `createdAt`, `-createdAt`. 
  /// * [search] - Case-insensitive substring match against email and display name.
  /// * [status] - Filter by account status.
  /// * [roleId] - Filter to users holding this role.
  /// * [includeDeleted] - Include soft-deleted users. Defaults to false.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UserPage] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserPage>> listUsers({ 
    int? page = 1,
    int? pageSize = 20,
    ...
    UserPage? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<UserPage, UserPage>(rawData, 'UserPage', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [User] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<User>> restoreUser({ 
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/v1/users/{userId}/restore'.replaceAll('{' r'userId' '}', userId.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
